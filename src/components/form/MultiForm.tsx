...
export function MultiForm() {
  ...
  return (
    <>
      ...
      />
      <div className="relative sm:overflow-visible z-10 flex h-[600px] w-[940px] max-w-full overflow-hidden rounded-2xl bg-white p-4 shadow-lg sm:py-0 sm:h-auto sm:flex-col sm:px-0">
        <FormSidebar
          imageWidth={274}
          imageHeight={568}
          active={activeStep}
